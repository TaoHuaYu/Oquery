...
namespace PostgreDB
{
    public class clsOracleReader
    {
        ...
        /// </summary>
        /// <remarks></remarks>
        private OracleCommand oCommand = new OracleCommand();
        ...
        private DataTable oDataTable; //private DataTable oDataTable = new DataTable();
        ...
        public bool ConnectTo(string strConnectionString)
        {
            ...
            {
                mConn.Open();
                txn = mConn.BeginTransaction(IsolationLevel.ReadCommitted);
        ...
        public void ExecuteQuery(object sqlQuery)
        {
            try
            {
                ...
                //oCommand = new OracleCommand(Convert.ToString(sqlQuery), mConn);
                //oDataAdapter = oCommand.ExecuteReader();// .ExecuteReader();

                oDataTable = new DataTable();
                oDataAdapter = new OracleDataAdapter(Convert.ToString(sqlQuery), mConn);
